...
public record EventRegistrationResponse(
        @Schema(description = "Registration ID", example = "123e4567-e89b-12d3-a456-426614174000") UUID id,
        @Schema(description = "Event details") EventResponse event,
        @Schema(description = "User details (null for guest registrations)") UserResponse user,
        @Schema(description = "Email address used for registration", example = "user@example.com") String email,
