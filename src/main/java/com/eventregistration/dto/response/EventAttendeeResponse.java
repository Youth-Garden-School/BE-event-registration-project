...
public record EventAttendeeResponse(
        ...
        @Schema(description = "Registration timestamp", example = "2023-11-15T10:30:00") LocalDateTime createdAt,
        @Schema(description = "Last update timestamp", example = "2023-11-16T14:45:00") LocalDateTime updatedAt,
        @Schema(
                        description = "ID of user who created this registration",
                        example = "123e4567-e89b-12d3-a456-426614174000")
                UUID createdBy,
        @Schema(
                        description = "ID of user who last updated this registration",
                        example = "123e4567-e89b-12d3-a456-426614174000")
                UUID updatedBy) {}
